...
use App\Http\Controllers\JobOffer\RespondToJobOfferController;
...
Route::get('/alumni/job_offers', AlumniJobOffersController::class)->middleware('account:alumni')->name('alumni.job_offers');
Route::post('/alumni/job-offers/{jobOffer}/response', RespondToJobOfferController::class)->middleware('account:alumni')->name('alumni.job_offers.respond');
...
Route::get('/employer/job_offers', EmployerJobOffersController::class)->middleware('account:employer')->name('employer.job_offers');
Route::get('/employer/job-offers', EmployerJobOffersController::class)->middleware('account:employer')->name('employer.job_offers.canonical');
